package com.egorov.bestnewscity;
...
public class BestNewsCityApplication {

    public static void main(String[] args) {
        SpringApplication.run(BestNewsCityApplication.class, args);
    }
        ...
        return args -> {
            var data = Flux.just(
                    new News("1", "Title for news 1", "Message for news #1", "Greg",
                            ...
                            LocalTime.of(15, 12).truncatedTo(ChronoUnit.MINUTES), "Not updated!"),
                    new News("2", "Title for news 2", "Message for news #2", "Bill",
                            List.of(CategoryNews.SPORT), LocalDate.of(2015, 1, 6),
                            LocalTime.of(10, 0).truncatedTo(ChronoUnit.MINUTES), "Not updated!"),
                    new News("3", "Title for news 3", "Message for news #3", "Tomas",
                            ...
                            LocalTime.of(0, 55).truncatedTo(ChronoUnit.MINUTES), "Not updated!"),
                    new News("4", "Title for news 4", "Message for news #4", "Anna",
                            ...
                            LocalTime.of(11, 5).truncatedTo(ChronoUnit.MINUTES), "Not updated!"),
                    new News("5", "Title for news 5", "Message for news #5", "Rita",
                            List.of(CategoryNews.POLITIC), LocalDate.of(2021, 7, 1),
                            LocalTime.of(21, 35).truncatedTo(ChronoUnit.MINUTES), "Not updated!"));
